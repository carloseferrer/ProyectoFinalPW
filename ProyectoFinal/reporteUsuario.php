...
if(isset($_POST['reportebtnUsuario'])){
    ...
    $pdf->SetTitle('Informe de los Usuarios');
    ...
    $pdf->SetX(28);
    $pdf->Cell(50,6,'Nombre del Usuario',1,0,'C',1);
    $pdf->Cell(50,6,'Correo Electronico',1,0,'C',1);
    $pdf->Cell(25,6,'Tipo',1,0,'C',1);
    $pdf->Cell(30,6,'Fecha de Registro',1,1,'C',1); 
    ...
    $sqlOrdenCompra = ("SELECT * FROM usertable");
    //$sqlTrabajadores = ("SELECT * FROM trabajadores");
    $query = mysqli_query($con, $sqlOrdenCompra);
    
    while ($dataRow = mysqli_fetch_array($query)) {
            $pdf->SetX(28);
            $pdf->Cell(50,6,$dataRow['name'],1,0,'C');
            $pdf->Cell(50,6,$dataRow['email'],1,0,'C');
            $pdf->Cell(25,6,$dataRow['estado'],1,0,'C');
            $pdf->Cell(30,6,(date('m-d-Y', strtotime($dataRow['fecha_registro']))),1,1,'C');
        }
