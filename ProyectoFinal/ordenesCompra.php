...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="addOrdenCompra.php" method="POST">
      <div class="modal-body" style="color:black;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre_proveedor" class="form-control" placeholder="Enter Course">
                        </div>

                        <div class="form-group">
                            <label> Direccion Proveedor </label>
                            <input type="text" name="direccion_proveedor" class="form-control" placeholder="Enter Course">
                        </div>
                                        ...
                                        <td>
                                            ...
                                            <td>
                                                <div style='margin-left:7px;'>
                                                    ...
                                                    <a class='action-css' style='margin-right: 5px; outline: hidden;'  href='editOrdenoCompra.php?id=$row[id_orden]'>
                                                        <i class='fa-solid fa-pen-to-square' style='color:#FFC107;'></i> </a>
                                                    <a class='action-css'  href='deleteOrdenCompra.php?id=$row[id_orden]'><i class='fa-solid fa-trash' style='color:red;'>  </i></a>
                                                </div>
                                            </td>
                                        ...
                                        <td>
                                            ...
                                            <td>
                                                <div style='margin-left:7px;'>
                                                    <a class='action-css' style='margin-right: 5px; outline: hidden;'  href='descargarReportesIdOrd.php?id=$row[id_orden]'>
                                                    <i class='fa-solid fa-file-pdf' style='color:green;'></i> </a>
                                                    <a class='action-css' style='margin-right: 5px; outline: hidden;'  href='editOrdenCompra.php?id=$row[id_orden]'>
                                                        <i class='fa-solid fa-pen-to-square' style='color:#FFC107;'></i> </a>
                                                    <a class='action-css'  href='deleteOrdenCompra.php?id=$row[id_orden]'><i class='fa-solid fa-trash' style='color:red;'>  </i></a>
                                                </div>
                                            </td>
