...
if ( $_SERVER ['REQUEST_METHOD'] == 'GET'){
    ...
    $id_orden = $_GET["id"];
    $sql_query = "SELECT * FROM orden_compra WHERE id_orden=$id_orden";
    ...
    do{
        ...
        $sql_query = "UPDATE orden_compra SET nombre_producto = '$nombre_producto', unidades = '$unidades', precio_producto = '$precio_producto', nombre_proveedor = '$nombre_proveedor',direccion_proveedor = '$direccion_proveedor', estado = '$estado' WHERE id_orden = $id_orden";
        $result = $con->query($sql_query);
        header('location: ordenesCompra.php');
        exit;
...
<body>
    ...
    <div class="container">
        ...
        <div class="p-4 p-md-5 pt-5">
            <h1 class="text-center">Editar Orden</h1> <br>
                ...
                <div class="card-body" style="color:black;">
                    <form method="POST" id="editarInventario">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre_proveedor" class="form-control" placeholder="Enter Course" value="<?php echo $nombre_proveedor;?>" required>
                        </div>

                        <div class="form-group">
                            <label> Direccion Proveedor </label>
                            <input type="text" name="direccion_proveedor" class="form-control" placeholder="Enter Course" value="<?php echo $direccion_proveedor;?>" required>
                        </div>
                ...
                <div class="card-footer">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <a class="btn btn-sm btn-secondary" href="OrdenesCompra.php">Cancelar</a>
                        </div>
                    </div>
                </div>
            </div>
