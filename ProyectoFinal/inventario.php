    ...
    <div class="modal-content">
      ...
      <form action="inventario.php" method="POST">
        <div class="modal-body" style="color:black;">
          ...
          <div class="form-group">
            <label>Tipo</label> 
                            <select class="custom-select" name="tipo_producto"aria-label="Default select example" id="" name="estado" required>
                            ...
                            <div class="form-group">
                              <label> Precio </label>
                              <input type="number" step="0.01" name="precio_producto" class="form-control" placeholder="Enter Course" required>
                            </div>
                            
                            <div class="form-group">
                              <label> Descripcion </label>
                              <input type="text" name="descripcion" class="form-control" placeholder="Enter Course" required>
                            </div>
            ...
            <div class="container">
              <div class="p-4 p-md-5 pt-5">
                <h1 class="text-center">Inventario de Insumos</h1> <br>
                <div class="card card-outline card-primary">
                  <?php
                  require_once "addInventario.php";
                  ...
                  <div class="card-header">
                    ...
                    <div class="card-tools float-right">
                      <form action="descargarReporteInventario.php" method="POST">
                        <button type="" name="reportebtnInventario" class="btn btn-flait btn-danger"><span class="fa-solid fa-file-pdf"></span> Reportes</button>
                      </form>
                    </div>
                  </div>
                        ...
                        while($row = $result->fetch_assoc()){
                            ...
                            if($row['estado']=="Activo"){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class='fw-normal mb-1'>$row[descripcion]</p>
                                    </td>
                                    ...
                                    <td>
                                        <div style='margin-left:8px;'>
                                            <a class='action-css' style='margin-right: 5px; outline: hidden;'  href='descargaReporteInventarioId.php?id=$row[id_producto]'>
                                            <i class='fa-solid fa-file-pdf' style='color:blue;'></i> </a>
                                            <a class='action-css' style='margin-right: 5px; outline: hidden;'  href='editInventario.php?id=$row[id_producto]'>
                                                <i class='fa-solid fa-pen-to-square' style='color:#FFC107;'></i> </a>
                                            <a class='action-css' href='deleteInventario.php?id=$row[id_producto]'><i class='fa-solid fa-trash' style='color:red;'>  </i></a>
                                        </div>
                                    </td>
